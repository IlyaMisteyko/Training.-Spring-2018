...
namespace WorkWithDoubleLib.Tests
{
    [TestFixture()]
    public class BinaryViewOfDoubleTests
    {
        ...
        public void DoubleIn64BitsTest(double number, string expected)
        {
            string actual = NumberRepresentationConverter.DoubleToBinaryString(number);
